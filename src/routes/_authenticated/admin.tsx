...
function columnsFor(e: Entity): string[] {
  ...
  if (e === "pairings") return ["user_facing_tradeoff", "song_a_id", "song_b_id", "lane", "diagnostic_weight", "recognition_score", "min_canon", "era_bucket", "cross_subculture", "is_bootstrap", "active"];
